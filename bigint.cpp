...
/* low bits of a * b */
bigint_word
bigint_word_mul_lo(bigint_word a, bigint_word b)
{
  return a * b;
}
...
/* high bits of a * b */
bigint_word
bigint_word_mul_hi(bigint_word a, bigint_word b)
{
...
bigint_word
bigint_word_add_get_carry(bigint_word *dst, bigint_word a, bigint_word b)
{
  a += b;
  *dst = a;
  return a < b;
...
/* dst = a - b, return carry */
bigint_word
bigint_word_sub_get_carry(bigint_word *dst, bigint_word a, bigint_word b)
{
  b    = a - b;
  *dst = b;
  return b > a;
...
int
bigint_word_bitlength(bigint_word a)
{
  int i;
...
int
bigint_word_count_trailing_zeros(bigint_word a)
{
  int i;
...
bigint_word
bigint_word_gcd(bigint_word a, bigint_word b)
{
  while (1)
  {
    if (!a) return b;
...
unsigned
bigint_uint_gcd(unsigned a, unsigned b)
{
  while (1)
  {
    if (!a) return b;
...
bigint *
bigint_reserve(bigint *dst, int capacity)
{
...
int
bigint_raw_cmp_abs(const bigint_word *a, int na, const bigint_word *b, int nb)
{
  int i;
...
int
bigint_cmp_abs(const bigint *a, const bigint *b)
{
  return bigint_raw_cmp_abs(a->words, a->size, b->words, b->size);
}

int
bigint_raw_cmp(const bigint_word *a, int na, int a_neg, const bigint_word *b, int nb, int b_neg)
{
...
int
bigint_cmp_abs_word(const bigint *a, bigint_word b)
{
  if (b == 0)
  {
...
void
bigint_raw_zero(bigint_word *dst, int from, int to)
{
  if (from >= to) return;
...
bigint *
bigint_set_neg(bigint *dst, int neg)
{
  dst->neg = neg;
  return dst;
}
...
bigint *
bigint_negate(bigint *dst)
{
  return bigint_set_neg(dst, !dst->neg);
}

int
bigint_raw_cpy(bigint_word *dst, const bigint_word *src, int n)
{
...
bigint *
bigint_cpy(bigint *dst, const bigint *src)
{
...
int
bigint_raw_truncate(const bigint_word *a, int n)
{
  while (n > 0 && a[n - 1] == 0)
    n--;
  return n;
...
void
bigint_raw_clr_bit(bigint_word *dst, unsigned bit_index)
{
...
bigint *
bigint_clr_bit(bigint *dst, unsigned bit_index)
{
...
bigint *
bigint_set_bit(bigint *dst, unsigned bit_index)
{
...
bigint_word
bigint_get_bit(const bigint *src, unsigned bit_index)
{
...
int
bigint_raw_mul_word_add(bigint_word *dst, const bigint_word *src, int n, bigint_word factor)
{
  int i;
  bigint_word carry = 0;
...
int
bigint_raw_mul_word(bigint_word *dst, const bigint_word *src, int n, bigint_word factor)
{
  int i;
  bigint_word carry = 0;
...
int
bigint_raw_mul_add(bigint_word *dst, const bigint_word *src_a, int na, const bigint_word *src_b, int nb)
{
  int i;
...
int
bigint_raw_add_word(bigint_word *dst, const bigint_word *src, int n, bigint_word b)
{
  int i;
  bigint_word carry = b;
...
int
bigint_raw_from_str_base(bigint_word *dst, const char *src, int base)
{
  int n = 0;
...
int
bigint_count_digits(const char *src)
{
  int n = 0;
  for (; *src; src++)
...
int
bigint_raw_add(bigint_word *dst, const bigint_word *src_a, int na, const bigint_word *src_b, int nb)
{
...
int
bigint_raw_sub(bigint_word *dst, const bigint_word *src_a, int na, const bigint_word *src_b, int nb)
{
...
int
bigint_raw_mul_karatsuba(bigint_word *dst, const bigint_word *a, int na, const bigint_word *b, int nb, bigint_word *tmp)
{
  /* so many */
  int n, k, m, m2;
...
bigint_mul(bigint *dst, const bigint *a, const bigint *b)
{
  ...
  if (dst != a && dst != b && na < BIGINT_KARATSUBA_WORD_THRESHOLD && nb < BIGINT_KARATSUBA_WORD_THRESHOLD)
  {
...
int
bigint_digits_bound(int n_digits_src, double src_base, double dst_base)
{
...
int
bigint_write_size(const bigint *a, double dst_base)
{
  double src_base = pow(2, BIGINT_WORD_BITS);
  return bigint_digits_bound(a->size, src_base, dst_base) + sizeof('-') + sizeof('\0');
}

bigint *
bigint_from_str_base(bigint *dst, const char *src, int src_base)
{
...
bigint *
bigint_from_str(bigint *dst, const char *src)
{
  return bigint_from_str_base(dst, src, 10);
}

bigint *
bigint_from_int(bigint *dst, int src)
{
...
bigint *
bigint_from_word(bigint *dst, bigint_word a)
{
...
int
bigint_raw_add_signed(bigint_word *dst, int *dst_neg, const bigint_word *a, int na, int a_neg, const bigint_word *b, int nb, int b_neg)
{
  if (a_neg)
  {
    if (b_neg)
...
bigint *
bigint_add_signed(bigint *dst, const bigint *a, int a_neg, const bigint *b, int b_neg)
{
  int na = a->size;
  int nb = b->size;
  ...
  dst->size = bigint_raw_add_signed(dst->words, &dst->neg, a->words, na, a_neg, b->words, nb, b_neg);
...
bigint *
bigint_add_word_signed(bigint *dst, const bigint *src_a, bigint_word b, int b_neg)
{
  int na = src_a->size;

  bigint_reserve(dst, na + 1);

  dst->size = bigint_raw_add_signed(dst->words, &dst->neg, src_a->words, na, src_a->neg, &b, 1, b_neg);

  return dst;
}

bigint *
bigint_add_word(bigint *dst, const bigint *src_a, bigint_word b)
{
  return bigint_add_word_signed(dst, src_a, b, 0);
}

bigint *
bigint_sub_word(bigint *dst, const bigint *src_a, bigint_word b)
{
  return bigint_add_word_signed(dst, src_a, b, 1);
}

int
bigint_raw_shift_left(bigint_word *dst, int n_dst, const bigint_word *src, int n_src, unsigned shift)
{
  int i;
...
int
bigint_raw_shift_right(bigint_word *dst, int n_dst, const bigint_word *src, int n_src, int shift)
{
  int i;
  int word_shift = shift / BIGINT_WORD_BITS;
  int bits_shift = shift % BIGINT_WORD_BITS;
...
bigint *
bigint_shift_left(bigint *dst, const bigint *src, unsigned shift)
{
...
bigint *
bigint_shift_right(bigint *dst, const bigint *src, unsigned shift)
{
  bigint_reserve(dst, src->size);
...
int
bigint_raw_bitlength(const bigint_word *src_a, int na)
{
  int last = na - 1;
  if (last < 0) return 0;
...
int
bigint_bitlength(const bigint *a)
{
  return bigint_raw_bitlength(a->words, a->size);
}

int
bigint_count_trailing_zeros(const bigint *a)
{
  int i;
  for (i = 0; i < a->size; i++)
  {
...
bigint *
bigint_div_mod(bigint *dst_quotient, bigint *dst_remainder, const bigint *src_numerator, const bigint *src_denominator)
{
  int shift;
...
bigint *
bigint_div(bigint *dst, const bigint *numerator, const bigint *denominator)
{
  bigint unused[1];
  bigint_init(unused);
...
bigint *
bigint_mod(bigint *dst, const bigint *numerator, const bigint *denominator)
{
  bigint unused[1];
  bigint_init(unused);
...
bigint *
bigint_div_mod_half_word(bigint *dst, bigint_word *dst_remainder, bigint_word denominator)
{
  int i, j;
...
bigint *
bigint_gcd(bigint *dst, const bigint *src_a, const bigint *src_b)
{
...
bigint *
bigint_sqrt(bigint *dst, const bigint *src)
{
  int bit;
  bigint sum[1], tmp[1];
...
char *
bigint_write_base(char *dst, int *n_dst, const bigint *a, bigint_word base, int zero_terminate)
{
  int i = 0, n = *n_dst;
...
char *
bigint_write(char *dst, int n_dst, const bigint *a)
{
  return bigint_write_base(dst, &n_dst, a, 10, 1);
}

bigint *
bigint_rand_bits(bigint *dst, int n_bits, bigint_rand_func rand_func)
{
...
bigint *
bigint_rand_inclusive(bigint *dst, const bigint *n, bigint_rand_func rand_func)
{
...
bigint *
bigint_rand_exclusive(bigint *dst, const bigint *n, bigint_rand_func rand_func)
{
  int n_bits = bigint_bitlength(n);
...
bigint *
bigint_pow_mod(bigint *dst, const bigint *src_base, const bigint *src_exponent, const bigint *src_modulus)
{
...
int
bigint_is_probable_prime(const bigint *n, int n_tests, bigint_rand_func rand_func)
{
...
bigint *
bigint_pow_word(bigint *dst, const bigint *base, bigint_word exponent)
{
  bigint result[1], p[1];
...
void
bigint_raw_get_high_bits(bigint_word *dst, int n_dst, const bigint_word *src_a, int na, int n_bits, int *n_bitlength)
{
  int shift;
...
double
bigint_double(const bigint *src)
{
