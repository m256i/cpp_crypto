...
#define BIGINT_REVERSE(type, data, n)                                                                                                      \
  ...
  char *bigint_write_base(char *dst, int *n_dst, const bigint *a, bigint_word base, int zero_terminate);
  ...
  bigint *bigint_div_mod(bigint *dst_quotient, bigint *dst_remainder, const bigint *src_biginterator, const bigint *src_denominator);

  bigint *bigint_div(bigint *dst, const bigint *numerator, const bigint *denominator);

  bigint *bigint_mod(bigint *dst, const bigint *numerator, const bigint *denominator);

  bigint *bigint_div_mod_half_word(bigint *dst, bigint_word *dst_remainder, bigint_word denominator);
  ...
  bigint *bigint_pow_mod(bigint *dst, const bigint *src_base, const bigint *src_exponent, const bigint *src_modulus);
